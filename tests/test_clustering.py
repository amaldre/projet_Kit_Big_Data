...
from src.pages.2_Clustering import main
...
@patch("src.pages.2_Clustering.st.components.v1.html")  # Mock de l'iframe
@patch("src.pages.2_Clustering.load_data")  # Mock de load_data
@patch("src.pages.2_Clustering.load_css")  # Mock de load_css
