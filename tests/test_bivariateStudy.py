...
# def test_display_graph_free_false_default_values_not_none():
#     df = pd.DataFrame(
#         {
#             "col1": [1, 2, 3, 4, 5],
#             "col2": [5, 4, 3, 2, 1],
...
#     study.default_values_save = study.default_values.copy()
...
#     assert result == True
#     assert study.default_values == study.default_values_save
#     assert study.axis_x == axis_x
#     assert study.axis_y == axis_y
#     assert (study.x == np.array([1, 2, 3, 4, 5])).all()
#     assert (study.y == np.array([5, 4, 3, 2, 1])).all()
#     assert (study.recipes_id == np.array([101, 102, 103, 104, 105])).all()
