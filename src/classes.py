...
class Study:
    ...
    def __init__(self, dataframe, axis_x_list, axis_y_list, key):
    ...
    def get_data_points(self, df, axis_x, axis_y, range_axis_x, range_axis_y):
        df = df[[axis_x,axis_y,"id"]].sort_values(by=axis_x)
    ...
    def display_graph(self):
        ...
        if self.delete ==False:
            with st.form(self.key):
                ...
                x, y, recipes_id = self.get_data_points(self.dataframe, self.axis_x, self.axis_y, self.range_axis_x, self.range_axis_y)
